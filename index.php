...
<main class="w-full max-w-3xl">
    ...
    <section class="mt-6">
        ...
        <p class="text-xs text-ink/40 mb-3">Neu eingereichte Links werden nach ~20s einmal automatisch erneut geprüft. Falls dann immer noch nichts da ist: einfach nochmal auf "VT prüfen" klicken.</p>
