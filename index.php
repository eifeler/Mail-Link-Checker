...
<main class="w-full max-w-3xl">
    ...
    <section class="mt-6">
        ...
        <p class="text-xs text-ink/40 mb-3">Links, die VirusTotal noch nie gesehen hat, brauchen etwas Zeit für die Analyse - das Tool fragt nach ~20s automatisch einmal nach. Falls dann immer noch nichts da ist: einfach nochmal auf "VT prüfen" klicken.</p>
